...
let { MessageType, MessageOptions, Mimetype, GroupSettingChange, ChatModification } = require('@NishNishendanidu/red-blacky web');
...
let { SendMessageImage } = require('red-blacky/sources/dc/cmd/dl')
