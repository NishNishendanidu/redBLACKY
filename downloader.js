...
await sendMessageDownloader(BlackyRed,input, 'mediafire')
                  ...
                  return await BlackyRed.client.sendMessage(QueenSew.jid,'Sorry I Could Not Find This Mediafire File!',MessageType.text, { quoted: QueenSew.data})
...
await sendMessageDownloader(BlackyRed, input, 'github')
                  ...
                  return await BlackyRed.client.sendMessage(QueenSew.jid,'Sorry I Could Not Find This Profile!',MessageType.text, { quoted: QueenSew.data})
